!function () {
    ...
    /*var element = document.createElement("div");
     element.id = "darkroom-icons", element.style.height = 0, element.style.width = 0, element.style.position = "absolute", element.style.visibility = "hidden", element.innerHTML = '<div><button id="close"><i class="fa fa-times" aria-hidden="true"></i></button><button id="crop"><i class="fa fa-times"></i></button>' +
     '<button id="done"><i class="fa fa-times"></i></button>'+
     '<button id="redo"><i class="fa fa-times"></i></button>'+
     '<button id="rotate-left"><i class="fa fa-times"></i></button>'+
     '<button id="rotate-right"><i class="fa fa-times"></i></button>'+
     '<button id="free-hand"><i class="fa fa-times"></i></button>'+
     '<button id="save"><i class="fa fa-times"></i></button>'+
     '<button id="undo"><i class="fa fa-times"></i></button></div>'
    ...
    function () {
        ...
        Darkroom.UI = {
            ...
            createButton: function (options) {
                ...
                buttonElement.type = "button", buttonElement.className = "darkroom-button darkroom-button-" + options.type, buttonElement.innerHTML = '<span class="darkroom-icon ' + options.iconClass + '"></span>', this.element.appendChild(buttonElement);
...
function() {
    ...
    var Rotation = Darkroom.Transformation.extend({
        applyTransformation: function(canvas, image, next) {
            ...
            next();
=======
>>>>>>> 0ed7b813bfa30d296cf15f337e076c1ca5b086bf
        }
    }(),
    function () {
        "use strict";
...
=======
    ...
    function (window, document, Darkroom, fabric) {
        ...
        Darkroom.plugins.history = Darkroom.Plugin.extend({
            ...
            /********************************************************************************/
            //this function is bringing two other buttom
            _initButtons: function () {
                var buttonGroup = this.darkroom.toolbar.createButtonGroup();
                return this.backButton = buttonGroup.createButton({
                    image: "undo",
